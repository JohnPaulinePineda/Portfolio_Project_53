...
* [**1. Table of Contents**](#TOC)
    ...
    * [1.6 Predictive Model Development](#1.6)
        ...
        * [1.6.3 Log-Logistic Accelerated Failure Time Model](#1.6.3)
        * [1.6.4 Log-Normal Accelerated Failure Time Model](#1.6.4)
...
### 1.6.3 Log-Logistic Accelerated Failure Time Model <a class="anchor" id="1.6.3"></a>


### 1.6.4 Log-Normal Accelerated Failure Time Model <a class="anchor" id="1.6.4"></a>
